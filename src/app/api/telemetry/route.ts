...
const payload = z.object({ type: z.enum(["error", "pageview"]), path: z.string().startsWith("/").max(160), message: z.string().max(300).optional(), context: z.record(z.string(), z.unknown()).optional() });
